/**
 * Bandeau outils enseignés dans YouTube Impact (cf. spec section 3).
 * Marquee compact, logos en texte stylisé en attendant les vrais SVG/PNG
 * fournis par Fanel. Pas de tentative d'image qui échoue.
 *
 * ⚠️ Ne JAMAIS titrer "ils nous font confiance".
 */
