...
const FAQS = [
  ...
  },
  {
    ...
    a: "Immédiat. Tu reçois tes accès à Branddeo Academy juste après ton inscription : modules, communauté, lives, toolbox. [À confirmer : durée d'accès — à vie ou 12 mois]",
  },
  {
